...
var zigzag_direction := 1 # horizontal direction of the zizag movement
...
func _physics_process(delta: float) -> void:
	...
	if fire:
		...
		# zizag movement
		position.x += zigzag_direction * 0.5 * speed * delta
...
func _on_alternate_zigzag_timer_timeout() -> void:
	zigzag_direction *= -1
